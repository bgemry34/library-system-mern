...
function UserManagement() {
    ...
    const [userForm, handleChange, setUserForm] = useForm({name:'', username:'', password:'', userType:''});
    ...
    const addDialog = (
        <Dialog
          ...
          onClose={()=>{
            setCreateModal(false);
            setUserForm({name:'', username:'', password:'', userType:''});
          }}
          scroll="body"
          fullWidth
        >
                    ...
                    <Grid item xs={6}>
                        <div>
                            <Button
                                variant="contained"
                                color="primary"
                                style={{background:'#27ae60', width:"30%", float:'right', marginTop:'13px'}}
                                endIcon={<AddIcon />}
                                onClick={()=>{
                                    setCreateModal(true)
                                    //console.log('Clicked')
