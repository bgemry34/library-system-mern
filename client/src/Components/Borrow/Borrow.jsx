    ...
    import { Container, Grid,Backdrop, CircularProgress, TextField, TableContainer, Paper, Table, Button, TableHead, TableRow, TableCell, TableBody, Typography } from '@material-ui/core';
        ...
        const overlayLoading = (
            <Backdrop className={classes.backdrop} open={loading}>
                <div style={{width:'50%'}}>
                    ...
                    (
                        <>
                            <CircularProgress style={{display:'block', margin:'auto'}}  color="inherit"/>
                            <Typography style={{textAlign:'center',marginTop:'10px'}}>{Math.ceil(loadingProgress)}%</Typography>
                        </>
                    ):
                    (
                        <>
                            <Typography style={{textAlign:'center',marginTop:'10px'}}>Successfully Borrow Book</Typography>
                            <Button
                            onClick={()=>{
                                setLoading(false);
                            }}
                            variant="contained" color="primary" style={{display:'block', margin:'auto', marginTop:'10px', backgroundColor:'#27ae60'}} >
                            Okay
                            </Button>
                        </>
                    )
                ...
                <Container className={styles.Container}  >
                    ...
                    >
                        ...
                        <Button
                            ...
                            startIcon={<SendIcon />}
                            disabled={
                                (borrowedBooksContainer.length && selectedUser) <= 0 
                            }
                            fullWidth
                            onClick={BorrowBook}
                        >
